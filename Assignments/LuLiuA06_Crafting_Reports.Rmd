---
title: 'LuLiuA06 - Crafting Reports'
author: "Lu Liu" 
date: "Spring 2025"
output: pdf_document
toc: true
...
knitr::kable(summary_PM25, caption = "Mean Particulates (2.5mm)", align = "c")
knitr::kable(summary_Ozone, caption = "Mean Ozone", align = "c")
```
...
```{r, echo=FALSE, fig.align='left', fig.height=4, fig.cap="2018 monthly Ozone levels", warning=FALSE}
# Filter data for 2018 and create a boxplot of Ozone levels by month
epa_data %>%
  filter(year(Date) == 2018) %>%
  ggplot(aes(x = factor(month(Date, label = TRUE)), y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Concentration (µg/m3)", title = "Monthly Ozone Concentrations (2018)") 
```


```{r, echo=FALSE, fig.align='left', fig.height=4, fig.cap="2019 monthly Ozone levels", warning=FALSE}
# Filter data for 2019 and create a boxplot of Ozone levels by month
epa_data %>%
  filter(year(Date) == 2019) %>%
  ggplot(aes(x = factor(month(Date, label = TRUE)), y = Ozone)) +
  geom_boxplot() +
  labs(x = "Month", y = "Concentration (µg/m3)", title = "Monthly Ozone Concentrations (2019)") 
```
---
...
## Git Repository
https://github.com/Celesteluliu/EDA_Spring2025/tree/main/Assignments