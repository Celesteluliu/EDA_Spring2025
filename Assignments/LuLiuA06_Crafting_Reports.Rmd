...
#Create the PM2.5 table, and name the columns and the title
knitr::kable(summary_PM25, 
    col.names = my_col.names, 
    caption = 'Mean Particulates (2.5mm)')

#Create the Ozone table, and name the columns and the title
...
```{r, echo=FALSE, fig.align='left', fig.height=3, fig.cap="2018 monthly Ozone levels", warning=FALSE, fig.show='hold'}
...
```{r, echo=FALSE, fig.align='left', fig.height=3, fig.cap="2019 monthly Ozone levels", warning=FALSE, fig.show='hold'}
